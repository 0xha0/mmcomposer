...
CONFIGS = {
    ...
    "tier2_overlap": (
        dict(skeleton="tier3_cluster_swizzle", BM=128, BN=256, BK=64, NS=5,
             ...
             EPILOGUE_OVERLAP=1, EPILOGUE_SPLIT=0, PERSISTENT=1, TWO_CTA=0, EPILOGUE_L1_NO_ALLOC=0),
        ["EPILOGUE_OVERLAP"],
    ),
    "tier2_sequential": (
        dict(skeleton="tier3_cluster_swizzle", BM=128, BN=256, BK=64, NS=3,
             GROUP_SIZE_M=8, NUM_WARPS=8, TMA_STORE=0, TCGEN05_LD_WIDTH=8,
             EPILOGUE_OVERLAP=0, EPILOGUE_SPLIT=0, PERSISTENT=0, TWO_CTA=0, EPILOGUE_L1_NO_ALLOC=0),
    ...
    "tier3_overlap": (
        dict(skeleton="tier3_cluster_swizzle", BM=128, BN=256, BK=64, NS=3,
             GROUP_SIZE_M=4, NUM_WARPS=8, TMA_STORE=0, TCGEN05_LD_WIDTH=8,
             EPILOGUE_OVERLAP=1, EPILOGUE_SPLIT=0, PERSISTENT=1, TWO_CTA=1, EPILOGUE_L1_NO_ALLOC=0),
        ["EPILOGUE_OVERLAP"],
    ),
    "tier3_overlap_split": (
        dict(skeleton="tier3_cluster_swizzle", BM=128, BN=256, BK=64, NS=5,
             GROUP_SIZE_M=4, NUM_WARPS=8, TMA_STORE=0, TCGEN05_LD_WIDTH=8,
             EPILOGUE_OVERLAP=1, EPILOGUE_SPLIT=1, PERSISTENT=1, TWO_CTA=1, EPILOGUE_L1_NO_ALLOC=0),
        ["EPILOGUE_OVERLAP"],
    ),
    "tier3_sequential": (
        dict(skeleton="tier3_cluster_swizzle", BM=128, BN=256, BK=64, NS=3,
             GROUP_SIZE_M=8, NUM_WARPS=8, TMA_STORE=0, TCGEN05_LD_WIDTH=8,
             EPILOGUE_OVERLAP=0, EPILOGUE_SPLIT=0, PERSISTENT=0, TWO_CTA=1, EPILOGUE_L1_NO_ALLOC=0),
        ["EPILOGUE_OVERLAP", "TMA_STORE", "TCGEN05_LD_WIDTH"],
    ),
    "tier3_overlap_split_l1noalloc": (   # exercises the EPILOGUE_L1_NO_ALLOC store macro
        dict(skeleton="tier3_cluster_swizzle", BM=128, BN=256, BK=64, NS=4,
             GROUP_SIZE_M=8, NUM_WARPS=4, TMA_STORE=0, TCGEN05_LD_WIDTH=8,
             EPILOGUE_OVERLAP=1, EPILOGUE_SPLIT=1, PERSISTENT=1, TWO_CTA=1, EPILOGUE_L1_NO_ALLOC=1),
